...
const TRANSITIONS: Record<GameState, GameState[]> = {
  IDLE_MENU: ['LAUNCH_PAD', 'ASCENT', 'ORBIT', 'DOCKING', 'ISS_EXPLORATION', 'MISSION_COMPLETE'],
  LAUNCH_PAD: ['ASCENT', 'IDLE_MENU'],
  ASCENT: ['ORBIT', 'DOCKING', 'IDLE_MENU'],
  ORBIT: ['DOCKING', 'ISS_EXPLORATION', 'IDLE_MENU'],
  DOCKING: ['ISS_EXPLORATION', 'ORBIT', 'IDLE_MENU'],
  ISS_EXPLORATION: ['MISSION_COMPLETE', 'IDLE_MENU'],
  MISSION_COMPLETE: ['IDLE_MENU', 'LAUNCH_PAD'],
};
